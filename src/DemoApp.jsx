...
// ── Mock crew members ───────────────────────────────────────────────────
const INITIAL_CREW = [
  { id: "crew_1", name: "Mike Torres", color: "#3B82F6", phone: "(410) 555-1001", email: "mike@example.com", avatarUrl: null, sortOrder: 0 },
  { id: "crew_2", name: "Dave Rivera", color: "#10B981", phone: "(410) 555-1002", email: "dave@example.com", avatarUrl: null, sortOrder: 1 },
  { id: "crew_3", name: "Carlos Martinez", color: "#8B5CF6", phone: "(410) 555-1003", email: "carlos@example.com", avatarUrl: null, sortOrder: 2 },
  { id: "crew_4", name: "Sarah Kim", color: "#F59E0B", phone: "(410) 555-1004", email: "sarah@example.com", avatarUrl: null, sortOrder: 3 },
];
    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <span style={{ fontSize: 14, fontWeight: 700, letterSpacing: "-0.02em" }}>Crew Scheduler</span>
          <span style={{ fontSize: 12, opacity: 0.5 }}>|</span>
          <span style={{ fontSize: 13, opacity: 0.7 }}>Interactive Demo</span>
          <span style={{ fontSize: 11, opacity: 0.4, marginLeft: 4 }}>— try dragging jobs to the calendar</span>
        </div>
        <a
          href="https://bizpresso.co"
          target="_blank"
          rel="noopener noreferrer"
          style={{
            color: "#60A5FA", textDecoration: "none", fontSize: 13, fontWeight: 600,
            padding: "6px 16px", borderRadius: 6, border: "1px solid rgba(96,165,250,0.3)",
            transition: "all .15s",
          }}
